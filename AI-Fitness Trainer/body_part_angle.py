...
class BodyPartAngle:
    ...
    def angle_of_the_plank(self):
        shoulder = detection_body_part(self.landmarks, "LEFT_SHOULDER")
    ...
    def angle_of_the_lunge(self):
        l_hip = detection_body_part(self.landmarks, "LEFT_HIP")
        l_knee = detection_body_part(self.landmarks, "LEFT_KNEE")
        l_ankle = detection_body_part(self.landmarks, "LEFT_ANKLE")
        return calculate_angle(l_hip, l_knee, l_ankle)

    def angle_of_the_deadlift(self):
        shoulder = detection_body_part(self.landmarks, "LEFT_SHOULDER")
        hip = detection_body_part(self.landmarks, "LEFT_HIP")
        knee = detection_body_part(self.landmarks, "LEFT_KNEE")
        return calculate_angle(shoulder, hip, knee)

    def angle_of_the_bicep_curl(self):
        shoulder = detection_body_part(self.landmarks, "LEFT_SHOULDER")
        elbow = detection_body_part(self.landmarks, "LEFT_ELBOW")
        wrist = detection_body_part(self.landmarks, "LEFT_WRIST")
        return calculate_angle(shoulder, elbow, wrist)
    
    def angle_of_the_shoulder_press(self):
        shoulder = detection_body_part(self.landmarks, "LEFT_SHOULDER")
        elbow = detection_body_part(self.landmarks, "LEFT_ELBOW")
        wrist = detection_body_part(self.landmarks, "LEFT_WRIST")
        return calculate_angle(shoulder, elbow, wrist)
    
    def angle_of_the_crunch(self):
        shoulder = detection_body_part(self.landmarks, "LEFT_SHOULDER")
        hip = detection_body_part(self.landmarks, "LEFT_HIP")
        knee = detection_body_part(self.landmarks, "LEFT_KNEE")
        return calculate_angle(shoulder, hip, knee)

    def angle_of_the_russian_twist(self):
        r_shoulder = detection_body_part(self.landmarks, "RIGHT_SHOULDER")
        l_shoulder = detection_body_part(self.landmarks, "LEFT_SHOULDER")
        r_hip = detection_body_part(self.landmarks, "RIGHT_HIP")
        l_hip = detection_body_part(self.landmarks, "LEFT_HIP")
        ...
        return calculate_angle(r_shoulder, shoulder_avg, hip_avg)

    def angle_of_the_jumping_jack(self):
        shoulder = detection_body_part(self.landmarks, "LEFT_SHOULDER")
        hip = detection_body_part(self.landmarks, "LEFT_HIP")
        ankle = detection_body_part(self.landmarks, "LEFT_ANKLE")
        return calculate_angle(shoulder, hip, ankle)
